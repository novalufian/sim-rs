        ...
        <div className='flex gap-2 flex-col md:flex-row col-span-12'>
            ...
            <div className="w-full md:w-[80%] flex-1">
                {activeTab === 'permohonan' && (
                    <div className="p-6">
                        <h1 className="text-2xl font-bold mb-4">Permohonan Kawin Cerai</h1>
                        <p className="text-gray-600 dark:text-gray-400">Halaman permohonan akan segera tersedia.</p>
                    </div>
                )}
                {activeTab === 'persetujuan' && (
                    <div className="p-6">
                        <h1 className="text-2xl font-bold mb-4">Persetujuan Kawin Cerai</h1>
                        <p className="text-gray-600 dark:text-gray-400">Halaman persetujuan akan segera tersedia.</p>
                    </div>
                )}
            </div>
        </div>
