...
export default function TrendPerceraianPerBulan() {
    const [filters, setFilters] = useState<StatistikBulanFilter>({});
    const { data, isLoading, isError, error } = useTrendPerceraianPerBulan(filters);
    ...
    if (isLoading) {
        return (
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg">
                <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">Trend Perceraian Per Bulan</h2>
