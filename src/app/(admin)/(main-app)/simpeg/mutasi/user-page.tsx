...
import MyApprovalMutasi from './persetujuan/page'
import MyMutasi from './permohonan/my-mutasi'
    ...
    return (
        <div className='flex gap-2 flex-col md:flex-row col-span-12'>
            ...
            <div className="w-full md:w-[80%] flex-1">
                {activeTab === 'permohonan' && <MyMutasi />}
                {activeTab === 'persetujuan' && <MyApprovalMutasi />}
            </div>
        </div>
    )
}
