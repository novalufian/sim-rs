...
import { useStatistikStatus } from "@/hooks/fetch/mutasi/useMutasiState";
...
export default function StatistikStatusChart() {
    ...
    if (isLoading) {
        return (
            <div className="rounded-4xl bg-white dark:border-gray-800 dark:bg-white/[0.03] box-border p-5 min-h-[360px] h-full flex flex-col items-center justify-center">
                <SpinerLoading title="Statistik Status Mutasi" />
            </div>
        );
    }
        ...
        datasets: [
            {
                ...
                backgroundColor: ["#3b82f6", "#10b981", "#ef4444", "#f59e0b", "#8b5cf6", "#ec4899", "#14b8a6", "#06b6d4"],
                borderWidth: 1,
                borderRadius: 10,
                spacing: 5,
            },
    ...
    return (
        <div className="rounded-4xl bg-white dark:border-gray-800 dark:bg-white/[0.03] box-border p-5 min-h-[360px] h-full flex flex-col items-center justify-start">
            ...
            <h2 className="text-2xl font-semibold mb-6 text-center text-gray-800 dark:text-gray-200">Statistik Status Mutasi</h2>
