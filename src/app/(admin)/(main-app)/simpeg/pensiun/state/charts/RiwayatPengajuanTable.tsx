...
import { useRiwayatPengajuan, StatistikPegawaiFilter } from "@/hooks/fetch/pensiun/usePensiunState";
...
export default function RiwayatPengajuanTable() {
    ...
    const riwayat = data?.data || { data: [], total: 0, page: 1, limit: 10 };
    ...
    return (
        <div className="rounded-4xl bg-white dark:border-gray-800 dark:bg-white/[0.03] box-border p-5 min-h-[360px] h-full flex flex-col">
            ...
            <h2 className="text-2xl font-semibold mb-6 text-center text-gray-800 dark:text-gray-200">Riwayat Pengajuan Pensiun</h2>
            ...
            {riwayat.data.length > 0 ? (
                <>
                    <div className="mb-2 text-sm text-gray-500 dark:text-gray-400">
                        Total: {riwayat.total} | Halaman {riwayat.page} | Limit: {riwayat.limit}
                    </div>
                    ...
                    {riwayat.total > riwayat.limit && (
                        <div className="mt-4 flex justify-center gap-2">
                            ...
                            <button
                                onClick={() => handlePageChange(riwayat.page + 1)}
                                disabled={riwayat.data.length < riwayat.limit}
                                className="px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                Selanjutnya
                            </button>
