...
interface SelectedPensiunProps {
    pensiun: PermohonanPensiunWithRelations | null;
}
...
export default function SelectedPensiun({ pensiun }: SelectedPensiunProps) {
    if (!pensiun) {
        return (
            <div className="p-4 text-center text-gray-500">
                Pilih permohonan pensiun untuk melihat detail
            </div>
        );
    }
            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 bg-gray-50 dark:bg-gray-800/50">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <p className="text-gray-900 dark:text-white font-medium">{pensiun.pegawai_nama || '-'}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-gray-900 dark:text-white">{pensiun.pegawai_nip || '-'}</p>
                    </div>
                </div>
            </div>

            {/* Section: Detail Pensiun */}
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 bg-gray-50 dark:bg-gray-800/50">
                <h3 className="text-sm font-semibold text-gray-500 dark:text-gray-400 mb-3 uppercase tracking-wide">
                    Detail Pensiun
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <p className="text-gray-900 dark:text-white">{pensiun.jenis_pensiun || '-'}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <div>{renderStatusBadge(pensiun.status)}</div>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-gray-900 dark:text-white">{formatDate(pensiun.tanggal_pengajuan)}</p>
                    </div>
                    ...
                    {pensiun.tanggal_pensiun && (
                        <div>
                            ...
                            <p className="text-gray-900 dark:text-white">{formatDate(pensiun.tanggal_pensiun)}</p>
                        </div>
                    )}
                </div>
            </div>

            {/* Section: Alasan Pensiun */}
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 bg-gray-50 dark:bg-gray-800/50">
                <h3 className="text-sm font-semibold text-gray-500 dark:text-gray-400 mb-3 uppercase tracking-wide">
                    Alasan Pensiun
                </h3>
