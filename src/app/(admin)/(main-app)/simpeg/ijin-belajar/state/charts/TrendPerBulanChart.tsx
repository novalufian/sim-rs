...
import { useTrendPerBulan, StatistikBulanFilter } from "@/hooks/fetch/belajar/useBelajarState";
...
export default function TrendPerBulanChart() {
    ...
    const chartData = {
        ...
        datasets: [
            ...
            {
                label: 'Tugas Belajar',
                data: statistik.trend_bulanan.map((item) => item.tugas_belajar),
            ...
            {
                label: 'Izin Belajar',
                data: statistik.trend_bulanan.map((item) => item.izin_belajar),
