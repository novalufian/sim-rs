...
export default function TopProgramStudiChart() {
    ...
    const top10 = [...statistik.top_program_studi]
    ...
    return (
        <div className="rounded-4xl bg-white dark:border-gray-800 dark:bg-white/[0.03] box-border p-5 min-h-[360px] h-full flex flex-col">
            ...
            <h2 className="text-2xl font-semibold mb-4 text-center text-gray-800 dark:text-gray-200">Top Program Studi</h2>
                ...
                <ol className="space-y-2 px-1">
                    ...
                    {top10.map((item, idx) => (
                        ...
                        >
                            ...
                            {/* Nama Program Studi dan Info */}
                            <div className="flex-1 ml-3 min-w-0">
                                <div className="font-semibold text-gray-900 dark:text-white truncate">
                                    {item.nama_program_studi}
                                </div>
                                <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                    {item.jenjang_pendidikan} • {item.bidang_ilmu}
                                </div>
                            </div>
