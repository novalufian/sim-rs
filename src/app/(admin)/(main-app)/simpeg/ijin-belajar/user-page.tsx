...
import MyPersetujuanBelajar from './persetujuan/my-persetujuan'
import MyIjinBelajar from './permohonan/my-ijin-belajar'
    ...
    return (
        <div className='flex gap-2 flex-col md:flex-row col-span-12'>
            ...
            <div className="w-full md:w-[80%] flex-1">
                {activeTab === 'permohonan' && <MyIjinBelajar />}
                {activeTab === 'persetujuan' && <MyPersetujuanBelajar />}
            </div>
        </div>
    )
}
