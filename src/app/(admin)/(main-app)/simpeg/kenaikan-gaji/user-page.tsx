...
import MyPersetujuanGaji from './persetujuan/my-persetujuan';
import MyGaji from './permohonan/my-gaji';
    ...
    return (
        <div className='flex gap-2 flex-col md:flex-row col-span-12'>
            ...
            <div className="w-full md:w-[80%] flex-1">
                {activeTab === 'permohonan' && <MyGaji />}
                {activeTab === 'persetujuan' && <MyPersetujuanGaji />}
            </div>
        </div>
    )
}
