...
export default function PegawaiQueryFilter({ onFilterChange }: PegawaiQueryFilterProps) {
    ...
    const _CLASSNAME_ =
        "appearance-none text-gray-500 transition-colors bg-white border border-gray-200 rounded-lg hover:text-dark-900 h-11 px-4 cursor-pointer hover:bg-gray-100 hover:text-gray-700 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white col-span-12";

    // Function to update URL parameters
    const updateURLParams = (filters: PegawaiFilterState) => {
